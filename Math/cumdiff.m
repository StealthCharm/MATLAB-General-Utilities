%[text] This function is the compliment to `cumsum()`. Instead of computing the summation along the specified dimensions it calculates the difference.
function A = cumdiff(A, dim, options)
    arguments(Input)
        A {mustBeNumeric}
